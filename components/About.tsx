					...
					<div className="grid grid-cols-1 md:grid-cols-2">
						<div className="p-8 md:p-12">
							<h2 className="text-3xl md:text-4xl font-bold mb-6 text-gray-800">
								Welcome to
								<span className="text-red-500 block mt-1"> Magic Chalk Kindergarten</span>
							</h2>
							...
							<div className="mt-8">
								<Link href="/about-us">
									<Button className="bg-red-600 hover:bg-red-700 text-white px-6 py-3 rounded transition-colors duration-300 inline-flex items-center group">
										Read More
