...
// 									<p className="text-md md:text-lg text-muted-foreground">Lalitpur, Satdobato</p>
// 								</div>
// 							</CardContent>
// 						</Card>
...
// 									<p className="text-md md:text-lg text-muted-foreground">+977 1-5454294</p>
// 								</div>
// 							</CardContent>
// 						</Card>
...
// 									<p className="text-md md:text-lg text-muted-foreground">magicchalk.edu@gmail.com</p>
// 								</div>
// 							</CardContent>
// 						</Card>
// 					</div>
