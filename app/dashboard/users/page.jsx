		...
		<div className="max-w-4xl">
			...
			<div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-2">
				<div className="flex gap-4 flex-1 items-center pl-2">
					...
					<button className="bg-green-700 text-white px-3 py-1 rounded disabled:opacity-50" onClick={handleBulkRoleChange} disabled={selectedUserIds.length === 0 || !bulkRole}>
						Apply Role
					</button>
				</div>
			</div>
			...
			{editUser && (
				<div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center">
					<div className="bg-white p-6 rounded-lg shadow-lg w-96">
						<h2 className="text-lg font-bold text-slate-200 bg-green-700 p-4 mb-6 text-center">Edit User</h2>
