		...
		<div className="pt-32">
			...
			<div className="min-h-screen bg-gray-50 py-8 px-4 sm:px-6 lg:px-8">
				<div className="max-w-5xl mx-auto">
					...
					<div className="w-24 h-1 bg-green-500 mx-auto mb-6 md:mb-12 rounded-full"></div> {formSuccess && <div className="mb-6 p-4 bg-green-100 border border-green-400 text-green-700 rounded-md">{formSuccess}</div>}
						...
						<div className="bg-white shadow rounded-lg p-6">
							...
							<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
								<div className="md:col-span-2">
									...
									<Input type="text" id="child-name" name="child-name" required className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500 capitalize" style={{ textTransform: "capitalize" }} />
								</div>
								<div>
									<label htmlFor="dob" className="block text-sm font-medium text-gray-700 after:content-['*'] after:text-red-500 after:ml-0.5">
										Date of Birth
									</label>
									<Input type="date" id="dob" name="dob" required max={new Date().toISOString().split("T")[0]} className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500" />
								</div>{" "}
								<div>
